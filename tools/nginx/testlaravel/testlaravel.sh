...
# To run this script use command: ./testlaravel.sh

# Path to input web service directory.
input_base_dir="/home/tester/Desktop/testlaravel"

# Path to server block file.
input_server_block_path="$input_base_dir/testlaravel.com"
...
destination_dir="/var/www/testlaravel.com"

# Path to nginx server block file for current web service.
nginx_sites_available_server_block_path="/etc/nginx/sites-available/testlaravel.com"
