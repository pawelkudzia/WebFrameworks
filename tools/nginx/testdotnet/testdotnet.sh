...
# To run this script use command: ./testdotnet.sh

# Path to input web service directory.
input_base_dir="/home/tester/Desktop/testdotnet"

# Path to server block file.
input_server_block_path="$input_base_dir/testdotnet.com"
...
destination_dir="/var/www/testdotnet.com"

# Path to nginx server block file for current web service.
nginx_sites_available_server_block_path="/etc/nginx/sites-available/testdotnet.com"
